...
CREATE VIEW INTERESES2 AS
SELECT afiliado,palabra,COUNT(palabra) AS apariciones FROM intereses
GROUP BY afiliado,palabra;

select * from INTERESES2;
